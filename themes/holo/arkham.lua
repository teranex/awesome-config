...
theme.fg_focus                      = "#4a89c7"
theme.bg_normal                     = "#1d1d1f"
theme.fg_urgent                     = "#FD971F"
theme.bg_urgent                     = "#1d1d1f"
-- theme.bg_minimize                   = theme.bg_normal
-- theme.fg_minimize                   = "#688696"
theme.bg_minimize                   = "#4a89c7"
theme.fg_minimize                   = theme.fg_normal
theme.useless_gap                   = 7
theme.border_width                  = 2
-- theme.border_normal                 = "#252525"
-- theme.border_normal                 = "#CECECE"
-- theme.border_normal                 = "#1d1d1f"
-- theme.border_normal                 = "#4C4745"
theme.border_normal                 = "#222426"
theme.border_focus                  = "#4a89c7"
theme.taglist_fg_focus              = "#FFFFFF"
theme.taglist_bg_focus              = "png:" .. theme.icon_dir .. "/arkham_taglist_bg_focus_21px.png"
theme.tasklist_bg_normal            = "#1d1d1f"
theme.tasklist_fg_focus             = "#4a89c7"
...
theme.taglist_squares_sel           = theme.icon_dir .. "/arkham_square_sel2.png"
theme.taglist_squares_unsel         = theme.icon_dir .. "/arkham_square_sel2.png"
...
theme.titlebar_bg_normal = "#1d1d1f"
theme.titlebar_bg_focus  = "#4a89c7"
...
theme.layout_thrizen = theme.layouts_dir .. "/thrizen.png"
